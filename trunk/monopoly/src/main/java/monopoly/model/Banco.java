...
public class Banco {
    ...
    /**
     * suma al dinero del jugador el monto indicado por cada jugador de la lista que no sea el
     * resta al dinero del resto de los jugadores el monto indicado
     * @param jugadores
     * 			todos los jugadores
     * @param jugador
    ...
    /**
     * resta al dinero del jugador 
     * el monto indicado para las casas por el numero de casas
     * mas el monto indicado para los hoteles por el numero de hoteles
     * @param jugador
     ...
     */
    public boolean cobrarPorCasaYHotel(Jugador jugador, int montoPorCasa, int montoPorHotel)
    {
    	int monto=jugador.getNroCasas()*montoPorCasa+jugador.getNroHoteles()*montoPorHotel;
    	return this.cobrar(jugador, monto);
    	
    }
    
    /**
     *toma una propiedad en hipotega y paga al jugador el valor indicado
     *para la hipoteca de esta propiedad
     *@param jugador
     ...
     *@return true so
     */
    public boolean hipotecarPropiedad(Jugador jugador, TarjetaPropiedad tarjetaPropiedad)
    {
    ...
    public boolean deshipotecarPropiedad(Jugador jugador, TarjetaPropiedad tarjetaPropiedad)
    {
    	return false;
    }
